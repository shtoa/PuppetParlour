...
// Shader for the 3D Scene 
inline ofShader sceneShader;

//--------------------------------------------------------------
static std::string glslWorley() {
	return R"(
		// 3D Worley Noise from https://github.com/Erkaman/glsl-worley/blob/master/worley3D.glsl
